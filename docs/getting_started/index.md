...
|What is auto-nodes?|Auto-nodes is basically, a simple, built-in node creation and managing function, which requires no outside setup.|
|Why would I use auto-nodes, over manual nodes?|It's up to you, making your own is completely fine, but auto-nodes will be more simple, for new-comers, and simple bots.|
